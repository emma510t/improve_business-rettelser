    ...
    <>
      <section className="h-[60vh] md:h-[75vh] relative">
        <div className="absolute top-0 bottom-0 left-0 right-0 z-[-1]">
          <Image src="/img/forside-hero.jpeg" height={4096} width={2681} alt="Forside billede af to konsulenter i et kontor" className="object-cover object-center h-full w-full" priority />
        </div>
        ...
        <Link href="#consultant-areas" aria-label="Konsulentområder" className="max-md:hidden">
          <Button
            hasChevron
            size="xlIcon"
      ...
      <section id="consultant-areas" className="mt-12 mb-24 md:mt-16 scroll-mt-28">
        <div className="max-w-[1280px] w-full px-2.5 sm:px-4 md:px-6 lg:px-8 xl:px-10 mx-auto">
          <div className=" min-[875px]:grid min-[875px]:grid-cols-2">
            <H2>Konsulentområder</H2>
            <P className="max-w-[640px]">
              Vi hjælper SMV’er med at udvikle og implementere processer, strategier og kommunikation, med bæredygtighed i centrum. Vores arbejde er målrettet og effektivt med det formål at opnå de
              bedste resultater for din virksomhed.
            </P>
          </div>
          <div>
      ...
      <SplitSection>
        ...
        <SplitSectionChild className="md:flex md:flex-col bg-ibsilver-200">
          <div className="max-w-[600px]">
            <H2>Akademiet</H2>
            <P>
              Vi har vendt rekruttering på hovedet - Improve Business tilbyder løsninger, der både sikrer danske virksomheders konkurrenceevne i et marked i forandring og samtidig har en betydelig
              samfundsmæssig værdi for mennesker uden for arbejdsmarkedet.
            </P>
            <P>
              Med Academy vender vi rekruttering på hovedet og tilbyder landets jobcentre, virksomheder og borger en casebaseret tilgang til rekruttering. Vi matcher blindt på baggrund af motivation
              og parkerer alle fordomme i rekruttering.
            </P>
          </div>
        ...
        <SplitSectionChild className="md:flex md:flex-col bg-ibsilver-500 text-ibsilver-100">
          <div className="max-w-[600px]">
            ...
            <P>
              ...
              at vi sammen skaber en positiv indvirkning på samfundet og miljøet.
            </P>
